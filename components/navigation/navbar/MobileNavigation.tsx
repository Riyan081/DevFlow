...
const MobileNavigation = () => {
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="bg-[#121212] border-r border-gray-800 w-80 p-0" suppressHydrationWarning>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-t border-gray-800 space-y-3">
            ...
            <SheetClose asChild>
              <Button variant="outline" className="w-full border-gray-600 bg-gray-900 dark: text-gray-300 hover:bg-gray-800 hover:text-white py-3 rounded-lg transition-colors">
                Sign up
              </Button>
            </SheetClose>
          </div>
